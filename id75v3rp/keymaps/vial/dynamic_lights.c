...
static const key_color_rule_t key_color_rules[] = {
    ...
    // Special Keys that are only backlit on Layer 0
    { KC_HOME,   CLR_PURPLE,    L(0) },
    { KC_PGUP,   CLR_PURPLE,    L(0) },
    { KC_PGDN,   CLR_PURPLE,    L(0) },
    { KC_UP,     CLR_BLUE,      L(0) },
    { KC_DOWN,   CLR_BLUE,      L(0) },
    { KC_LEFT,   CLR_BLUE,      L(0) },
    { KC_RGHT,   CLR_BLUE,      L(0) },
    // --- Layer 2 --- USER Keys
    { 0x7E06,    CLR_MINT,       L(2) },
    { 0x7E07,    CLR_LEMONGREEN, L(2) },
    { 0x7E08,    CLR_GREY,       L(2) },
    { 0x7E09,    CLR_GREY,       L(2) },
    { 0x7E0A,    CLR_GREY,       L(2) },
    ...
    { KC_5,         CLR_GREY,       L(4) },
    { KC_6,         CLR_GREY,       L(4) },
    { QK_MACRO_0,   CLR_DARKGREEN,  L(4) },
    { QK_MACRO_1,   CLR_DARKGREEN,  L(4) },
    { QK_MACRO_2,   CLR_DARKGREEN,  L(4) },
    { QK_MACRO_3,   CLR_DARKGREEN,  L(4) },
    { QK_MACRO_4,   CLR_DARKGREEN,  L(4) },
    { QK_MACRO_5,   CLR_DARKGREEN,  L(4) },
    { QK_MACRO_6,   CLR_DARKGREEN,  L(4) },
